...
SCRATCH=${CWD}/results/run_1 ############ should be change !!
mkdir ${SCRATCH}
...
echo "year division text NMF" >> ${SCRATCH}/logfile.txt
...
python ${SRCPATH}/06prep_NLP_NMF.py --cwd ${CWD} --scratch ${SCRATCH} --input ${SCRATCH}/proc_data/out05_text_all.json --no_below 2 --no_above ${WORD_thre} --dim ${LDADIM} --tfidf 0
