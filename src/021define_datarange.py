...
import numpy as np
import sys
sys.path.append(r'/Users/noro/Documents/Projects/AnalyseFinance/FSanalysis/Shiraberu')
...
parser.add_argument('--input', default=r"../run_1/proc_data/out02_diff_data_all.pkl.cmp", type=str, help='input file path')
...
# %% ##########################################################################
# gather the information to make mask
###############################################################################

responce_data_masked=pd.read_pickle(args.base_scratch+"/proc_data/out02_docIDinfo.pkl")


filename=PROJDIR+"../metadata/EdinetcodeDlInfo1903.csv" #業種情報 01prepを参照
...
mask_train=mask_JGAAP & mask_consolidated & mask_gt_201503 & mask_lt_202003
mask_test=mask_JGAAP & mask_consolidated & mask_eq_202003
